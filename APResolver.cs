...
namespace SpotifyLibV2
{
    public static class ApResolver
    {
        ...
        public static async System.Threading.Tasks.Task<string> GetClosestDealerAsync()
        {
        ...
        public static async System.Threading.Tasks.Task<string> GetClosestSpClient()
        {
        ...
        public static async System.Threading.Tasks.Task<(string host, int port)> GetClosestAccessPoint()
        {
