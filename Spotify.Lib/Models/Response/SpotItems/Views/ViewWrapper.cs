...
namespace Spotify.Lib.Models.Response.SpotItems.Views
{
    ...
    {
        [JsonProperty("custom_fields")] public object CustomFields { get; set; }

        [JsonProperty("href")] public string Href { get; set; }

        [JsonProperty("id")] public string Id { get; set; }

        [JsonProperty("content")] public Paging<T> Content { get; set; }
        ...
        [JsonProperty("images")] public List<ViewImage>? Images { get; set; }
    }
