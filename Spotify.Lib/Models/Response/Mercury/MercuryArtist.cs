...
namespace Spotify.Lib.Models.Response.Mercury
{
    ...
    public struct ArtistsPlaylistsWrapper
    {
    ...
    public struct ArtistGalleryObject
    {

    }
    public struct ArtistMerchanidseObject
    {
        [JsonPropertyName("items")]
        public IEnumerable<MerchItem> Items { get; set; }
    }

    public struct MerchItem
    {
        /// <summary>
        /// Name of the item
        /// </summary>
    ...
    public struct MercuryArtistShortInfo
    {
        /// <summary>
        /// Name of the artist
        /// </summary>
        ...
        public List<MercuryCover> Portraits { get; set; }
    ...
    public struct ArtistTopTracksObject
    {
        /// <summary>
    ...
    public class ArtistTopTrack : PlaycountedTrack, ITrackItem
    {
        ...
        public List<ISpotifyItem> Artists { get; }
    }
    public struct ArtistRelatedArtistsObject
    {
        /// <summary>
    ...
    public struct ArtistRelated : ISpotifyItem
    {
        ...
        public ISpotifyId Id => _id ??= new ArtistId(Uri);
        public string Uri { get; set; }
    ...
    public struct ArtistHeaderImage
    {
        /// <summary>
        /// https CDN Url.
        /// </summary>
    ...
    public struct ArtistDiscographyObject
    {
        /// <summary>
        /// Albums wrapper.
        /// </summary>
    ...
    public struct DiscographyWrapper
    {
    ...
    public struct QuickArtist : ISpotifyItem
    {
        private ISpotifyId _id;
        public ISpotifyId Id => _id ??= new ArtistId(Uri);
        public AudioItemType Type => AudioItemType.Artist;
