...
namespace Spotify.Lib.Connect.Contexts
{
    internal class RestrictionsManager
    {
        ...
        private readonly Connectstate.Restrictions _restrictions;

        private RestrictionsManager(AbsSpotifyContext context)
        {
        ...
        public static RestrictionsManager From(AbsSpotifyContext context)
        {
            return new RestrictionsManager(context);
        }
        ...
        public Connectstate.Restrictions ToProto() => _restrictions;
