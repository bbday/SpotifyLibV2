...
{
    public class AudioDecrypt : IAudioDecrypt
    {
        ...
        public void DecryptChunk(int chunkIndex, [NotNull] byte[] buffer, int size = 0)
        {
            var iv = IvInt.Add(
                BigInteger.ValueOf(size == 0 ? ChannelManager.CHUNK_SIZE * chunkIndex / 16
                    : size * chunkIndex / 16));
        ...
        /// <summary>
        /// Average decrypt time for <see cref="ChannelManager.CHUNK_SIZE"/> bytes of data.
        /// </summary>
        /// <returns></returns>
